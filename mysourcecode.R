...
source("/Users/abdelilahmoulida/Desktop/projet-tuteure-master/myheadercode.R")
...
mosaicplot(table(Basepatient_state), main = "Etat des patients au debut", xlab = "Etats", color = 1:3)
...
mosaicplot(table(Apatient_state), main = "Etat des patients eu traitement A", xlab = "Etats", color = 1:3)
...
mosaicplot(table(Bpatient_state), main = "Etat des patient eu traitement B", xlab = "Etats", color = 1:3)
...
for(i in 1:350)
{
  if(DATA$After[i] < DATA$Before[i])
    cat("A ", i, " smoke ", DATA$Smoke[i], " gender ", DATA$Gender[i], "\n")
}

for(i in 351:700)
{
  if(DATA$After[i] < DATA$Before[i])
    cat("B ", i, " smoke ", DATA$Smoke[i], " gender ", DATA$Gender[i], "\n")
}

'(*****) score des traitements : prediction de la regression logistique'
score = 0
for(i in 1:350)
{
